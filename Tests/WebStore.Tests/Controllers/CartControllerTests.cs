...
namespace WebStore.Tests.Controllers
{
    ...
    public class CartControllerTests
    {
        ...
        [TestMethod]
        public async Task CheckOut_Calls_Service_Returns_Redirect()
        {
            var cart_service_mock = new Mock<ICartServices>();
            cart_service_mock
            ...
            const string expected_username = "TestUser";
            ...
            var controller = new CartController(cart_service_mock.Object)
            {
                ControllerContext = new ControllerContext
                {
                    ...
                    {
                        User = new ClaimsPrincipal (new ClaimsIdentity (new[] { new Claim (ClaimTypes.Name, expected_username) } ))
                    }
                },

            };

            var order_viewmodel = new OrderViewModel { Address = "Address", Name = "Name", Phone = "111" };

            var result = await controller.CheckOut(order_viewmodel, order_service_mock.Object);
